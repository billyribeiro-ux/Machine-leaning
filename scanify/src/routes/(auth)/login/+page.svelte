...
<div class="auth-page" style="background: var(--bg-void);">
  <div class="auth-container">
    ...
    <div class="auth-card" style="background: var(--bg-surface); border: 1px solid var(--border-subtle);">
      ...
      <!-- Divider -->
      <div class="divider">
        <div class="divider-line" style="background: var(--border-subtle);"></div>
        <span class="divider-text" style="color: var(--text-disabled);">or sign in with email</span>
        <div class="divider-line" style="background: var(--border-subtle);"></div>
      </div>
      ...
      <form onsubmit={handleSubmit} class="auth-form">
        ...
        <div class="field-group">
          <label for="email" class="field-label" style="color: var(--text-secondary);">
            Email address
          </label>
          <input
            id="email"
        ...
        <div class="field-group">
          <div class="field-header">
            <label for="password" class="field-label" style="color: var(--text-secondary);">
              Password
            </label>
            <a href="/forgot-password" class="forgot-link" style="color: var(--accent);">
              Forgot password?
            </a>
          </div>
    ...
    <p class="auth-footer" style="color: var(--text-tertiary);">
      ...
      <a href="/signup" class="auth-footer-link" style="color: var(--accent-bright);">
        Sign up
      </a>
    </p>
  </div>
